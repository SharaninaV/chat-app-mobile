...
export const PhotoPreview = () => {
  ...
  return (
    <View style={styles.photoPreview}>
      <ImageBackground source={{ uri: filePath, height: "85%" }} resizeMode="cover"
                       style={styles.photoPreview__backgroundImage}>
        <View style={styles.photoPreview__buttons}>
          <TouchableOpacity onPress={handleCancel} style={styles.photoPreview__buttons__item}>
            <Text style={styles.photoPreview__buttons__item__text}>Отмена</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={handleSendPhoto} style={styles.photoPreview__buttons__item}>
            <Text style={styles.photoPreview__buttons__item__text}>Отправить</Text>
          </TouchableOpacity>
        </View>
      </ImageBackground>
    </View>
